...
const TextEditor: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen bg-editor-bg overflow-hidden relative">
      ...
      <div className="h-[60px] border-b border-editor-separator flex items-center justify-center px-4 bg-black bg-opacity-90 backdrop-blur-md z-10">
      ...
      <div className="p-6 overflow-y-auto" style={{ height: 'calc(100vh - 60px)' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative mb-8 p-6 rounded-lg bg-gradient-to-br from-gray-900 to-black border border-editor-separator">
            ...
            {/* Кнопка в виде плюсика для добавления новой области (справа сверху) */}
                ...
                <div key={rating.id} className="space-y-2 group">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                      ...
                      {/* Кнопки управления (редактирование, удаление и информация) – все появляются при наведении */}
                      <button
                        onClick={() =>
                          editingRating && editingRating.id === rating.id
          ...
          {/* Текстовые поля (например, ПЛЮСЫ и МИНУСЫ) */}
          ...
          {/* Надпись "гайд" под окнами (центрально) */}
            ...
            <Dialog open={isGuideOpen} onOpenChange={setIsGuideOpen}>
              ...
              <DialogContent className="bg-black text-green-500 border border-green-700 p-4 rounded-lg transition-all duration-300">
                <div className="mt-4 text-sm text-center">
                  ...
                  <br /><br />
                  Также снизу есть две области: "плюсы" и "минусы" в целом по игре.
                  <br /><br />
